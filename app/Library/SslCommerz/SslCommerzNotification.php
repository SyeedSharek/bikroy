...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function setCustomerInfo(array $info)
    {
        ...
        // $this->data['user_id'] = (isset($info['user_id'])) ? $info['user_id'] : null; // string (50)	Mandatory - Your customer name to address the customer in payment receipt email

        // $this->data['subscriptionType_id'] = (isset($info['subscriptionType_id'])) ? $info['subscriptionType_id'] : null; // string (50)	Mandatory - Your customer supcription type
